...
class SettingsActivity : AppCompatActivity(), OnSharedPreferenceChangeListener {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            appNamePref = findPreference(getString(R.string.pref_key_app_name))!!
            themePref = findPreference(getString(R.string.pref_key_theme))!!
            aboutPrefs = findPreference(getString(R.string.pref_key_about))!!
            //val summary: Spannable = SpannableString(getString(R.string.author))
            //summary.setSpan(ForegroundColorSpan(requireContext().color(R.color.sky_blue)), 0, summary.length, 0)
            //aboutPrefs.summary = summary
    ...
    class ManageTabsFragment : PreferenceFragmentCompat() {
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
