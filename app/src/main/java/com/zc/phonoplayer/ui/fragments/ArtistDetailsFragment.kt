...
class ArtistDetailsFragment : Fragment() {
    private lateinit var songCallback: SongAdapter.SongCallback
    ...
    override fun onAttachFragment(childFragment: Fragment) {
        if (childFragment is SongFragment) childFragment.setSongCallback(songCallback)
        if (childFragment is AlbumFragment) childFragment.setAlbumCallback(albumCallback)
    }

    fun setCallback(songCallback: SongAdapter.SongCallback, albumCallback: AlbumAdapter.AlbumCallback) {
